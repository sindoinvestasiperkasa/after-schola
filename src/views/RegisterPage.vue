<template>
  ...
  <header id="top-header">
    <div class="container">
      <div class="let-yoy-page-section-full pt-30">
      ...
      <div class="remember-section">
        <div class="footer-checkbox-sec">
          <input
            ...
            type="checkbox"
          />
          <label for="footer-checkbox" class="footer-chec-txt"
            >Remember Me</label
          >
        </div>
      </div>
      ...
      <div class="sign-in-social-media">
        <div class="sign-in-social-media-full">
          <a
            ...
            target="_blank"
            class="sign-in-social-media-deatails"
          >
            <svg
              width="24"
              height="24"
