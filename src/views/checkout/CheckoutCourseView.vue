<template lang="">
    ...
    <section id="checkout-screen">
        ...
        <div class="checkout-screen-content">
            <div class="container">
                <div class="review-first-sec-wrap mt-32">
                    <div class="overall-review">
                        <h2 class="third-txt1">Payment Method</h2>
                    </div>
                    <div class="view-all-descrip">
                        <a href="/addPaymentMethod">
                            <span class="checkout-addtxt">Add</span>
                            <span><img src="/assets/images/checkout-screen/plus-icon.svg" alt="plus-icon-"></span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="check-out-payment-bottom">
                <div class="payment-method-checkoutpage-full payment-mode mt-16">
                    <div class="check-select-mode">
                        <input type="radio" data-target="payment-screen.html"   id="payment-1" name="payment-option" checked >
                    ...
                    <div class="check-select-mode">
                        <input type="radio" data-target="payment-screen.html" id="payment-2" name="payment-option" >
                    ...
                    <div class="check-select-mode">
                        <input type="radio" data-target="payment-screen.html" id="payment-3" name="payment-option" >
                    ...
                    <div class="check-select-mode">
                        <input type="radio" data-target="payment-screen.html"  id="payment-4" name="payment-option" >
                    ...
                    <div class="check-select-mode">
                        <input type="radio" data-target="payment-screen.html" id="payment-5" name="payment-option" >
                    ...
                    <div class="check-select-mode">
                        <input type="radio" data-target="payment-screen.html"  id="payment-6" name="payment-option" >
        ...
        <div class="container">
            <div class="check-out-payment">
                <div class="check-out-payment-wrap">
                    <div class="check-out-coupon-sec">
                        <div class="review-first-sec-wrap mt-32">
                            <div class="overall-review">
                                <h2 class="third-txt1">Apply Coupon</h2>
                            </div>
                            <div class="view-all-descrip">
                                <a href="/addCoupon">
                                    <span class="checkout-addtxt">Add</span>
                    ...
                    <div class="checkout-price-sec mt-32">
                        <div class="checkout-price-sec-wrap">
                            <h3 class="check-txtt5">Price</h3>
                            <div class="checkoutpage-boder"></div>
                            <div class="checkout-price-content">
                                <div class="checkout-price mt-12">
                                    <span class="check-price1">1 items</span>
                                    <span class="check-price1">$149.00</span>
                                </div>
                                <div class="checkout-price mt-12">
                                    <span class="check-price1">Coupon Offer</span>
                                    <span class="check-price1 color-green">- $00.00</span>
                                </div>
                                <div class="checkout-price mt-12">
                                    <span class="check-price2">Total Price</span>
                                    <span class="check-price2">$149.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="pay-now-btn mt-32">
                        <a href="/addPaymentMethod">Pay Now</a>
                    </div>
                </div>
            </div>
        </div>
