              ...
              <div class="shop-now2-sec">
                <div class="offer-details">
                  ...
                  <div class="discount-txt mt-16">
                    <p>
                      Get a discount for every course order!<br />Only valid for
                      today!
                    </p>
                  </div>
                </div>
            ...
            <div class="carousel-item">
              <div class="shop-now2-sec">
                <div class="offer-details">
                  ...
                  <div class="discount-txt mt-16">
                    <p>
                      Get a discount for every course order!<br />
      ...
      <div class="trending-course-bottom-wrap mt-16">
        <div class="trending-course-details single-course">
          <div class="trending-course-details">
            <div class="trending-course-img">
              <img
                src="/assets/images/trending-course/course1.png"
                alt="course-img"
                class="w-100"
              />
              <div class="trending-bookmark">
                ...
                >
                  <img
                    src="/assets/svg/black-bookmark.svg"
                    alt="bookmark-icon"
                  />
                </a>
              </div>
              ...
              <div class="trending-course-price">
                ...
                <div>
                  <span class="trending-txt4"
                    ><img
                      src="/assets/images/single-courses/orange-fill-star.svg"
                      alt="star-img"
                  /></span>
        ...
        <div class="trending-course-details single-course">
          <div class="trending-course-details">
            <div class="trending-course-img">
              <img
                src="/assets/images/trending-course/course2.png"
                alt="course-img"
                class="w-100"
              />
              <div class="trending-bookmark">
      ...
      <div class="home-mentor-bottom mt-16">
        <div class="home-mentor-sec-wrap redirect-mentor">
          <div class="home-mentor-sec">
            <div>
              <img
                src="/assets/images/homescreen/mentor1.png"
                alt="mentor-img"
              />
            </div>
          </div>
        ...
        <div class="home-mentor-sec-wrap redirect-mentor">
          <div class="home-mentor-sec">
            <div>
              <img
                src="/assets/images/homescreen/mentor2.png"
                alt="mentor-img"
              />
            </div>
          </div>
        ...
        <div class="home-mentor-sec-wrap redirect-mentor">
          <div class="home-mentor-sec">
            <div>
              <img
                src="/assets/images/homescreen/mentor3.png"
                alt="mentor-img"
              />
            </div>
          </div>
        ...
        <div class="home-mentor-sec-wrap redirect-mentor">
          <div class="home-mentor-sec">
            <div>
              <img
                src="/assets/images/homescreen/mentor4.png"
                alt="mentor-img"
              />
            </div>
          </div>
