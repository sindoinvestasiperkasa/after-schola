                ...
                <div class="chat">
                    ...
                    <div class="chat-input">
                        <button type="submit" class="message-submit messages-plus-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask0_231_828" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                        ...
                        <div class="message-box">
                            ...
                            <svg class="specker" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none">
                            <mask id="mask0_3_3619" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                            width="24" height="24">
                            <rect width="24" height="24" fill="white" /></mask>
                            <g mask="url(#mask0_3_3619)">
                                <path class="specker-file"
                                ...
                                stroke="#555555" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                                <path class="specker-file" d="M8 21H16" stroke="#555555" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                                <path class="specker-file" d="M12 17V21" stroke="#555555" stroke-width="2"
                        ...
                        <button type="submit" class="message-submit">
                            ...
                            viewBox="0 0 24 24" fill="none">
                            <mask id="mask0_3_3689" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                            width="24" height="24">
                            <rect width="24" height="24" fill="white" /></mask>
